...
namespace TheHostingTool\Http\Middleware;

use FastRoute\Dispatcher;
use TheHostingTool\Http\Exceptions\MethodNotAllowedException;
use TheHostingTool\Http\Exceptions\RouteNotFoundException;
