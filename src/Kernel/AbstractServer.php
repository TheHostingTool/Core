...
abstract class AbstractServer
{
    ...
    public function getApp()
    {
        ...
        $app->instance('tht.config', $this->config);
        ...
        $app->register('TheHostingTool\Database\DatabaseServiceProvider');
        $app->register('TheHostingTool\Settings\SettingsServiceProvider');
        //TODO: Local Service Provider
        ...
        if ($app->isInstalled() && $app->isUpToDate()) {
            $settings = $app->make('TheHostingTool\Settings\SettingsRepositoryInterface');
            ...
            //TODO: Register Core, API, and Admin interfaces here

            foreach ($this->extendCallbacks as $callback) {
                $app->call($callback);
            }

            $app->register('TheHostingTool\Extension\ExtensionServiceProvider');
        }
    ...
    protected function registerLogger(Application $app)
    {
        ...
        $logPath = $app->storagePath().'/logs/thehostingtool.log';
