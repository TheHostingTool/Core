...
use TheHostingTool\Database\DatabaseServiceProvider;
use TheHostingTool\Settings\SettingsServiceProvider;
...
class Kernel
{
	...
	protected function getApp()
	{
		...
		$app->instance('tht.config', $this->getConfig());
