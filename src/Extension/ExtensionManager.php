...
use TheHostingTool\Events\Extension\ExtensionWasDisabled;
use TheHostingTool\Events\Extension\ExtensionWasEnabled;
use TheHostingTool\Events\Extension\ExtensionWasUninstalled;
use TheHostingTool\Events\Extension\ExtensionWillBeDisabled;
use TheHostingTool\Events\Extension\ExtensionWillBeEnabled;
    ...
    public function getExtensions()
    {
        if (is_null($this->extensions) && $this->filesystem->exists($this->app->basePath().'/vendor/composer/installed.json')) {
            ...
            foreach ($installed as $package) {
                if (Arr::get($package, 'type') != 'tht-extension' || empty(Arr::get($package, 'name'))) {
                    continue;
                }
            ...
            $this->extensions = $extensions->sortBy(function ($extension, $name) {
                return $extension->composerJsonAttribute('extra.tht-extension.title');
            });
        }
