...
class Theme implements Arrayable
{
     ...
     *
     * @info    Identical to the directory in the styles directory.
     * @example tht_default
     *
     * @var string
     */
    ...
    /**
     * The installed version of the Theme.
     *
     * @var string
     */
    protected $version;
    ...
    /**
     * Assigns the id for the Theme used globally.
     */
    protected function assignId()
    {
        list($vendor, $package) = explode('/', $this->name);
        $package = str_replace(['tht-theme-', 'tht-'], '', $package);
    ...
    {
        if (($icon = $this->composerJsonAttribute('extra.tht-theme.icon'))) {
    ...
    /**
     * Tests whether the Theme has assets.
     *
     * @return bool
     */
    ...
    /**
     * Tests whether the Theme has migrations.
     *
     * @return bool
     */
